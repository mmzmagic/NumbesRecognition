...
class DigitProphet(object):
    def __init__(self):
        ...
        trainX, _trainX, trainY, _trainY = train_test_split(images_train/255.,values_train,test_size=0.33)
...
def predict_image(ifile):

    data=get_image_data(ifile)
    save_image(data)
    return dp.predict_image(data)    

def main():
    filename="pic_test131.png"
    print(predict_image(filename))
    filename="pic_test230.png"
    print(predict_image(filename))
    filename="pic_test268.png"
    print(predict_image(filename))
    filename="pic_test331.png"
    print(predict_image(filename))
    pass
